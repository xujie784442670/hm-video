...
```
{
	...
	video{
		...
		"type":"喜剧",//视频类型
		//发布时间
		"createTime":"createTime":"2022-12-05 23:59:59",
		"views":4566852,//视频播放量
		"likes":852456,//视频点赞量
	}
}
...
```json
{
	...
	"data":{
        ...
        "Video":{["id":1,//视频id
                 ...
                 "accountId":1,//视频发布者id
                 "nickName":"老刘",//视频发布者昵称
    			 "barrages":1235,//视频弹幕数量
    			 "collections":852,//视频收藏量
    			 "status":0,//视频状态:0-正常,1-禁用
    			 "comments":852,//视频评论数
    			 "likes":85,//视频点赞数
    			 "logicalDelete":0,//逻辑删除:0-未删除,1-已删除
    			 "views":852//播放量
                ],								
    			["id":1,
                 "title":"奥特曼之我的兄弟叫顺溜",
...
> 请求地址:/video/findVideosByAccountId
...
| 参数名        | 默认值 | 类型          | 是否必传 | 描述                 | 验证规则 |
| ------------- | ------ | ------------- | -------- | -------------------- | -------- |
| videoManageVo |        | VideoManageVo | 是       | 从前端接收的视频对象 |          |
...
```json
{
	...
	"videoManageVo":{
        ...
        "typeId":1,//视频类型id
        "state":0,//视频状态
        "nickName":"xxxx",//视频发布者，用于查询和接收从数据库中返回的信息
        "createTimes":[2022-12-05 12:05:03,2022-12-05 12:05:04]，//视频创建时间范围，用于查询
    	"videoType":"xxxx",//视频类型，用于接收从数据库中返回的信息
    	"coverUrl":"xxx",//视频封面地址，用于接收从数据库中返回的信息
    	"createTime":"2022-12-05 12:05:03"，//视频创建时间，用于接收从数据库中返回的信息
    	"videoUrl":"http://xx",//视频内容地址，用于接收从数据库中返回的信息
    	"status":0,//视频状态，用于接收从数据库中返回的信息
    	"logicDelete":0,//逻辑删除
    	"page":1,//当前页
    	"pageSize":10//每页数据量
    },
